...
export const USM_COIN_SUPPLY = parseWithDecimals(10_000_000_000);
export const MOJO_COIN_SUPPLY = parseWithDecimals(10_000_000_000);
export const ZERO_ADDRESS = "0x0000000000000000000000000000000000000000";

export const BORROWING_FEE = 0.001; // 0.1%
